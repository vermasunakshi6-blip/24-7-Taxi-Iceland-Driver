...
class PrivacyPolicyStaticDriver extends StatefulWidget {
  const PrivacyPolicyStaticDriver({super.key});

  @override
  State<PrivacyPolicyStaticDriver> createState() =>
      _PrivacyPolicyStaticDriverState();
}

class _PrivacyPolicyStaticDriverState extends State<PrivacyPolicyStaticDriver> {
