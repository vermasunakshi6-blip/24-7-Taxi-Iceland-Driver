...
class DrivingLicenseBack extends StatefulWidget {
  List<File>? image;
  List<String>? path;
  List<File>? imageBack;
  List<String>? imagepathback;
  DrivingLicenseBack(
      {super.key, this.image, this.path, this.imageBack, this.imagepathback});
  @override
  State<DrivingLicenseBack> createState() => DrivingLicenseBackState();
}

class DrivingLicenseBackState extends State<DrivingLicenseBack> {
                                  ...
                                  docProvider.isloading
                                      ...
                                      : Expanded(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                docProvider.addDrivingPhoto(
                                                    context,
                                                    driverId!,
                                                    widget.path,
                                                    widget.imagepathback,
                                                    vehicledetailId!);
                                              },
                                              style: ElevatedButton.styleFrom(
                                                backgroundColor:
  ...
  Future<void> pickImage(ImageSource source) async {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        widget.imageBack = imageFiles;
        widget.imagepathback = imageFilesPath;
      }
    });
  }
