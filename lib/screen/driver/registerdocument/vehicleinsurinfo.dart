...
class VehicleInsurInfo extends StatefulWidget {
  VehicleInsurInfo({super.key, required this.isNewVehicel});
  bool isNewVehicel = false;
  @override
  State<VehicleInsurInfo> createState() => VehicleInsurInfoState();
}

class VehicleInsurInfoState extends State<VehicleInsurInfo> {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => VehicleInsurPhoto(
                      image: imageFiles,
                      path: imageFilesPath,
