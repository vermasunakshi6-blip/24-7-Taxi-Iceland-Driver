...
class DrivingLicInfo extends StatefulWidget {
  const DrivingLicInfo({super.key});
  @override
  State<DrivingLicInfo> createState() => DrivingLicInfoState();
}

class DrivingLicInfoState extends State<DrivingLicInfo> {
                      ...
                      child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                AppStrings.takePhotoDrivingLicense,
                                style: blackTitle,
                              ),
                              const SizedBox(
                                height: 20,
                              ...
                              const Align(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image(
                                    ...
                                    height: 180,
                                    image: AssetImage(
                                      'assets/images/driving_licence_demo.png',
                                    ),
                                    fit: BoxFit.fitWidth,
                                  ),
                                ),
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => DrivingLicenseFront(
                    image: imageFiles, path: imageFilesPath)));
      }
    });
  }
