...
class VehicleInsurPhoto extends StatefulWidget {
  List<File>? image;
  List<String>? path;
  bool isNewVehicel = false;
  VehicleInsurPhoto(
      {super.key, this.image, this.path, required this.isNewVehicel});
  @override
  State<VehicleInsurPhoto> createState() => VehicleInsurPhotoState();
}

class VehicleInsurPhotoState extends State<VehicleInsurPhoto> {
                              ...
                              docProvider.isloading
                                  ...
                                  : Expanded(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () {
                                            docProvider.addVehicleInsPhoto(
                                                context,
                                                driverId!,
                                                widget.path,
                                                widget.isNewVehicel,
