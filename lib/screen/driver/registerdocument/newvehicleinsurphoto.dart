...
class NewVehicleInsurPhoto extends StatefulWidget {
  List<File>? image;
  List<String>? path;
  String? vehicleid;
  NewVehicleInsurPhoto(
      {super.key, this.image, this.path, required this.vehicleid});
  @override
  State<NewVehicleInsurPhoto> createState() => NewVehicleInsurPhotoState();
}

class NewVehicleInsurPhotoState extends State<NewVehicleInsurPhoto> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                AppStrings.continueUploadingVehicle,
                                style: blackTitle,
                              ),
                              Text(
                              ...
                              docProvider.isloading
                                  ...
                                  : Expanded(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () {
                                            docProvider.newaddVehicleInsPhoto(
                                                context,
                                                driverId!,
                                                widget.path,
                                                widget.vehicleid!);
