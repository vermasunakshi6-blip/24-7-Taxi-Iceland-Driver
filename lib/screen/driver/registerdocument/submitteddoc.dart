...
class SubmittedDoc extends StatefulWidget {
  const SubmittedDoc({super.key});
  @override
  State<SubmittedDoc> createState() => SubmittedDocState();
}

class SubmittedDocState extends State<SubmittedDoc> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        '${AppStrings.welcome.toUpperCase()} JAMES',
