...
class NewVehicleRCPhoto extends StatefulWidget {
  List<File>? image;
  List<String>? path;
  String? vehicleid;
  ...
  @override
  State<NewVehicleRCPhoto> createState() => NewVehicleRCPhotoState();
}

class NewVehicleRCPhotoState extends State<NewVehicleRCPhoto> {
